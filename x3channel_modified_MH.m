...
% This cell is modified new since last version, MH <130105>
...
%% Smooth data
data = smoothdata(data, 10);  %10
datasmoothed = data;


% % compute maxima
 supersmoothdata = smoothdata(data, 50);  %10
